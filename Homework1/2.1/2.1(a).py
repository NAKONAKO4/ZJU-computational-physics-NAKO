...
# 计算黑咖啡和加奶咖啡的 r
r_black_mean, r_black_std = calculate_r(time_black, temp_black, ambient_temp)
r_cream_mean, r_cream_std = calculate_r(time_cream, temp_cream, ambient_temp)
